...
class DbusDlmsMeterService(object):
	def __init__(self, servicename, deviceinstance, paths, productname='DLMS Grid Meter', connection='RS485 ttyUSB0',
				 productid=0):
		...
		self._dbusservice.add_mandatory_paths(
			__file__, platform.python_version(),
			connection, deviceinstance,
			productid=41392,
